--[[
	Early Warning Radar Script (EWRS) - Version 1.6.0 - 07/11/2025
	
	Original Author: Steggles (Bob7heBuilder)
	Original Repository: https://github.com/Bob7heBuilder/EWRS
	
	Recent Enhancements by: HeavenDCS (2025)
	- Updated for DCS 2.9+ API compatibility
	- Added 30+ modern aircraft types (F-14, F-16C, F/A-18C/E/F, F-15E, AV-8B, A-10C II, JF-17, AH-64D, Su-30, Su-34, Mirage F1, Tornado, etc.)
	- Expanded radar units list with modern SAM systems
	- Activated all naval radar units (carriers, destroyers, frigates)
	- Verified MIST 4.5.126 compatibility
	...
	Built and Tested in DCS 2.9+ - See https://github.com/Bob7heBuilder/EWRS for the latest version

	This script requires MIST 4.5.126 or later - https://github.com/mrSkortch/MissionScriptingTools
	All MIST function calls have been verified against mist_4_5_126.lua
	...
	- 1.5.3 - Fixed bug with maxThreatDisplay set at 0 not displaying any threats
			...
			- Added C-101CC
	- 1.6.0 - Updated for DCS 2.9+ API compatibility
			- Added modern aircraft types (F-14A/B, F-16C, F/A-18C/E/F, F-15E, AV-8B, A-10C II, JF-17, Mirage-F1, AH-64D, F-4E, MB-339, MiG-19P, Su-30, Su-34, Tornado, Yak-52)
			- Updated radar units list with modern systems
			- Verified MIST 4.5.126 compatibility
]]
...
Ships with radar are included and functional in DCS 2.9+
]]
ewrs.validSearchRadars = {
-- SAM Systems (Ground-based)
...
"Dog Ear radar",		--Dog Ear (P-40) EWR
...
-- Naval Units with Radar (Modern DCS 2.9+)
...
Updated for DCS 2.9+ with modern aircraft types
]]
ewrs.acCategories = {
-- Attack Aircraft
[ "A-10A"          ] = ewrs.ATTACK  ,
[ "A-10C"          ] = ewrs.ATTACK  ,
[ "A-10C_2"        ] = ewrs.ATTACK  , -- A-10C II
[ "AV8BNA"         ] = ewrs.ATTACK  , -- AV-8B Harrier
...
[ "L-39C"		   ] = ewrs.ATTACK	,
[ "L-39ZA"         ] = ewrs.ATTACK  ,
[ "MB-339A"        ] = ewrs.ATTACK  , -- MB-339
[ "MB-339APAN"     ] = ewrs.ATTACK  ,
[ "MiG-15bis"      ] = ewrs.ATTACK  ,
[ "MiG-19P"        ] = ewrs.ATTACK  , -- MiG-19P Farmer
...
[ "Su-25TM"        ] = ewrs.ATTACK	,
[ "TF-51D"         ] = ewrs.ATTACK	,
[ "Yak-52"         ] = ewrs.ATTACK  , -- Yak-52

-- Fighter Aircraft
[ "F-14A-135-GR"   ] = ewrs.FIGHTER , -- F-14A Tomcat
[ "F-14B"          ] = ewrs.FIGHTER , -- F-14B Tomcat
[ "F-15C"          ] = ewrs.FIGHTER ,
[ "F-15E"          ] = ewrs.FIGHTER , -- F-15E Strike Eagle
[ "F-15ESE"        ] = ewrs.FIGHTER ,
[ "F-16C_50"       ] = ewrs.FIGHTER , -- F-16C Viper
[ "F-16C bl.50"    ] = ewrs.FIGHTER ,
[ "F-16C bl.52d"   ] = ewrs.FIGHTER ,
[ "F-4E-45MC"      ] = ewrs.FIGHTER , -- F-4E Phantom II
[ "F-86F Sabre"	   ] = ewrs.FIGHTER ,
[ "FA-18C_hornet"  ] = ewrs.FIGHTER , -- F/A-18C Hornet
[ "F/A-18C"        ] = ewrs.FIGHTER ,
[ "FA-18E_lot20"   ] = ewrs.FIGHTER , -- F/A-18E Super Hornet
[ "FA-18F_lot20"   ] = ewrs.FIGHTER , -- F/A-18F Super Hornet
[ "JF-17"          ] = ewrs.FIGHTER , -- JF-17 Thunder
[ "M-2000C"		   ] = ewrs.FIGHTER , -- Mirage 2000C
[ "Mirage-F1CE"    ] = ewrs.FIGHTER , -- Mirage F1
[ "Mirage-F1EE"    ] = ewrs.FIGHTER ,
[ "Mirage-F1BE"    ] = ewrs.FIGHTER ,
[ "MiG-29A"		   ] = ewrs.FIGHTER	, -- MiG-29A Fulcrum (full-fidelity module)
[ "MiG-29G"		   ] = ewrs.FIGHTER	, -- MiG-29G Fulcrum (German variant)
[ "MiG-29K"		   ] = ewrs.FIGHTER	, -- MiG-29K Fulcrum (Carrier variant)
[ "MiG-29S"		   ] = ewrs.FIGHTER	, -- MiG-29S Fulcrum
[ "Su-27"          ] = ewrs.FIGHTER	,
[ "Su-30"          ] = ewrs.FIGHTER , -- Su-30 Flanker
[ "Su-33"		   ] = ewrs.FIGHTER ,
[ "Su-34"          ] = ewrs.FIGHTER , -- Su-34 Fullback
[ "Tornado GR4"    ] = ewrs.FIGHTER , -- Tornado GR4
[ "Tornado IDS"    ] = ewrs.FIGHTER , -- Tornado IDS

-- Helicopters
[ "AH-64D_BLK_II"  ] = ewrs.HELO    , -- AH-64D Apache
[ "Apache_AH64D"   ] = ewrs.HELO    ,
[ "Ka-50"          ] = ewrs.HELO    ,
[ "Ka-50_3"        ] = ewrs.HELO    ,
[ "Mi-8MT"         ] = ewrs.HELO    ,
[ "Mi-24P"         ] = ewrs.HELO    ,
[ "Mi-24V"         ] = ewrs.HELO    ,
[ "OH58D"          ] = ewrs.HELO    , -- OH-58D Kiowa
[ "SA342M"		   ] = ewrs.HELO	,
[ "SA342L"		   ] = ewrs.HELO	,
